...
while movimiento < 200:  
    """
    Se repite la función del movimiento de las hormigas las veces que el usuario lo pida/la cantidad de veces
    ...
    Y luego un segundo join que para cada fila (o sea cada lista) las une con un salto de línea para darle la forma de grilla.
    """
    if movimiento > 0:               
        movimiento_hormigas(grilla)
    # Por iteción se suma 1 a un contador
    movimiento += 1
